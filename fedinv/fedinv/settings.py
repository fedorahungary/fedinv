...
ADMINS = (
     ('Levente Kurusa', 'levex@fedoraproject.org'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'db_default',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ecc2wrpe%h*2l4lmci37rfgmaq&^-07z9m9yj_d3i$nthan)xr'
...
ROOT_URLCONF = 'fedinv.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fedinv.wsgi.application'
